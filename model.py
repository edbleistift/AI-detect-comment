...
df = df.drop(columns=['Unnamed: 0.1', 'Unnamed: 0']) # Удаление ненужных столбцов

print("Фильтрация и создание меток...")
df = df[df['rating'].isin([1, 2, 4, 5])]  # Удаление нейтральных оценок
...
df = df.dropna(subset=['combined_text']) # Удаление строк с пустыми значениями в combined_text
